...
class RAGCreator():
    ...
    def load_documents(self, reader, kwargs:dict):
        try:
            docs = reader().load_data(**kwargs)
    ...
    def setup_and_deploy_RAG(self, reader, reader_kwargs, 
        ...
        self.load_documents(reader, reader_kwargs)
